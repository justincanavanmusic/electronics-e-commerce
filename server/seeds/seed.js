...
db.once('open', async () => {
    ...
    const products = await Product.insertMany([
        ...
        {
            name: "ASUS ROG Strix G16 G614JI-XS96 16 Gaming Laptop Computer - Eclipse Gray",
            price: 2199.99,
        ...
        {
            name: "Glorious GMMK2 RGB Mechanical 96% Gaming Keyboard - Black",
            price: 119.99,
        ...
        {
            name: "Redragon K552 Kumara 75% RGB Gaming Mechanical Keyboard - Black",
            price: 39.99,
        ...
        {
            name: "Logitech G G703 LIGHTSPEED RGB Wireless Optical Gaming Mouse - Black",
            price: 89.99,
        ...
        {
            name: "Razer Basilisk V3 Pro Ergonomic Wireless Gaming Mouse - White Edition",
            price: 159.99,
